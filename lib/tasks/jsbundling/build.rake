...
module Jsbundling
  module Tasks
    ...
    def install_command
      ...
      return "npm install" if File.exist?('package-lock.json') || (tool_exists?('npm') && !File.exist?('yarn.lock'))
    ...
    def build_command
      ...
      return "npm run build" if File.exist?('package-lock.json') || (tool_exists?('npm') && !File.exist?('yarn.lock'))
